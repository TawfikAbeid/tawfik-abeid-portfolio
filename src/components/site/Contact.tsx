...
export function Contact() {
  ...
  return (
    <section id="contact" className="grain border-t border-white/10 bg-ink text-ivory">
      <div className="relative z-10 mx-auto grid max-w-[1400px] gap-16 px-5 py-24 md:grid-cols-2 md:px-10 md:py-36">
        <div>
          ...
          <dl className="mt-14 space-y-6 text-sm">
            ...
            <div>
              <dt className="eyebrow text-ivory/45">Phone</dt>
              <dd className="mt-2">
            ...
            <div>
              <dt className="eyebrow text-ivory/45">LinkedIn</dt>
              <dd className="mt-2">
                <a
        ...
        <form onSubmit={onSubmit} className="space-y-6 md:pt-24">
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={5}
              className="mt-3 w-full resize-none border-b border-ivory/25 bg-transparent pb-3 text-sm outline-none transition-colors placeholder:text-ivory/35 focus:border-lime"
          ...
          <button
            type="submit"
            disabled={sending}
            className="rounded-sm bg-lime px-6 py-3 text-sm text-ink transition-opacity duration-300 hover:opacity-90 disabled:opacity-60"
          >
            Send message
          </button>
        </form>
  ...
  return (
    <div>
      ...
      <input
        ...
        type={type}
        required
        className="mt-3 w-full border-b border-ivory/25 bg-transparent pb-3 text-sm outline-none transition-colors focus:border-lime"
      />
    </div>
  );
}
