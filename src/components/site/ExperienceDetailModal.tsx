        ...
        {experience && (
          <>
            ...
            <div className="flex-1 overflow-y-auto px-6 py-8 md:px-9">
              <span className="eyebrow rounded-full bg-lime px-3 py-1 text-ink">
                {experience.kind}
              </span>
              ...
              <div className="mt-8 flex flex-col gap-3">
                {experience.proofLinks.map((link) => (
                  <ExternalRow key={link.href + link.label} label={link.label} href={link.href} fallback="" />
                ))}
                {!experience.proofLinks.length && (
                  <>
                    <ExternalRow
                      label="LinkedIn profile"
                      href={experience.linkedInPost}
                      fallback="Link to be added"
                    />
                    <ExternalRow
                      label="Organization"
