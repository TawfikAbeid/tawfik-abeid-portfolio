      ...
      {item && (
        ...
        >
          <button
            ...
            className="absolute right-5 top-5 rounded-full border border-ivory/30 p-2 text-ivory transition-colors hover:bg-ivory/10"
          >
            <X className="h-5 w-5" />
          </button>
          <figure onClick={(e) => e.stopPropagation()} className="max-h-full max-w-4xl">
            ...
            />
            <figcaption className="mt-4 flex flex-wrap items-center justify-between gap-3 text-sm text-ivory/80">
